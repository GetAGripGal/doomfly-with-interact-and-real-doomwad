...
export const metadata:Metadata={
 ...
 alternates:{canonical:'https://fly-brain-doom.awormuth.chatgpt.site/how-it-works'},
 openGraph:{title:'How it works · DOOMFLY',url:'https://fly-brain-doom.awormuth.chatgpt.site/how-it-works',images:['https://fly-brain-doom.awormuth.chatgpt.site/og.png']},
};
...
export default function HowItWorks(){
 return <main className="arcade how-page">
  ...
  <section className="how-arena" aria-labelledby="spectator-title"><h2 id="spectator-title">YOU GET THE CAMERA. THE BRAIN KEEPS THE CONTROLLER.</h2><p>The optional 3D view puts an illustrated fly holding a gun at the Doom player’s actual position and heading. Arena boundaries and object positions come from the engine; their appearance is simplified. Moving your camera changes only your view. The brain still receives the original first-person pixels.</p><p>Wings are decorative, not simulated flight muscles. The avatar sits above the ground-moving player; it does not add a flying action. The viewer smooths between received positions without predicting future movement and freezes on signal loss. Clips record this spectator illustration at 30 video frames per second; that does not speed up the brain. No observer coordinates enter the neural input, reinforcement or button mapping.</p></section>
